...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "bson_ext.gemspec", "ext/cbson/extconf.rb", "ext/lib/bson_ext.rb", "ext/cbson/buffer.c", "ext/cbson/cbson.c", "ext/cbson/encoding_helpers.c", "ext/cbson/buffer.h", "ext/cbson/encoding_helpers.h", "ext/cbson/version.h"]
