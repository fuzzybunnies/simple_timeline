...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "bson.gemspec", "LICENSE.txt", "lib/bson.rb", "lib/bson/bson_c.rb", "lib/bson/bson_ruby.rb", "lib/bson/byte_buffer.rb", "lib/bson/exceptions.rb", "lib/bson/ordered_hash.rb", "lib/bson/types/binary.rb", "lib/bson/types/code.rb", "lib/bson/types/dbref.rb", "lib/bson/types/min_max_keys.rb", "lib/bson/types/object_id.rb", "lib/bson/types/objectid.rb", "bin/b2json", "bin/j2bson", "test/mongo_bson/basic_test.rb", "test/mongo_bson/binary_test.rb", "test/mongo_bson/bson_test.rb", "test/mongo_bson/byte_buffer_test.rb", "test/mongo_bson/jruby_bson_test.rb", "test/mongo_bson/jruby_encode_test.rb", "test/mongo_bson/json_test.rb", "test/mongo_bson/object_id_test.rb", "test/mongo_bson/ordered_hash_test.rb"]
